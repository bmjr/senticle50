...
class PresenceOfWordsService:
    ...
    def get_similar_tweets(self):
        ...
        tweets = ClassifiedTweet.objects.all() \
            .values_list('tweet_id_id', 'tweet_id_id__tokenizedtweet__tokens').distinct('tweet_id_id__tokenizedtweet__tokens')
        print('Got tweets')
        ...
        while next_batch:
            ...
            one_hot_encoded_text_vectors = tokenizer.sequences_to_matrix(
                tokenizer.texts_to_sequences(tweet_texts), mode='binary')
