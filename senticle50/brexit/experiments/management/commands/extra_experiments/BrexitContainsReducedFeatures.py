...
class Command(BaseCommand):
    ...
    def new_model(self):
        ...
        tweets = list(
            Tweet.objects.filter(classifiedtweet__classification_type=7,
        ...
        # Save the tokenizer
        with open('brexit_contains_reduced_features_sentiment_tokenizer.pickle',
                  'wb') as handle:
        ...
        with open("brexit_contains_reduced_features_sentiment_keras_model.json",
                  "w") as json_file:
            json_file.write(model_json)
        brexit_model.save_weights(
            "brexit_contains_reduced_features_sentiment_keras_weights.h5")
        print("Model Saved")
